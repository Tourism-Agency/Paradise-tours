...
function createData(id, bookingID, date, customerID, packageID, booked_date, no_of_days, no_of_visitors, payment_status, guideID, transportID) {
  return { id, bookingID, date, customerID, packageID, booked_date, no_of_days, no_of_visitors, payment_status, guideID, transportID };
}

const rows = [
  createData('1', '23', '12/7/21', '234', '7', '19/7/21', '3', '4', '25% paid', '12', '4'),
...
export default function RejectedBookings() {
  ...
  const {data: bookData} = useBookings({status:'rejected'});
    ...
    <h1>Rejected Bookings</h1> 
      ...
      <Table className={tableClass.table} aria-label="customized table">
        <TableHead>
          ...
          <StyledTableCell>ID</StyledTableCell>
            ...
            <StyledTableCell align="left">REASSIGN</StyledTableCell>
            <StyledTableCell align="left">REASSIGN</StyledTableCell>
      ...
      >
        ...
        >
          ...
          <StyledTableCell align="left"><Button onClick={handleClickOpen4}>{row.transport_id}</Button></StyledTableCell>
              <Dialog
            open={open4}
            onClose={handleClose4}
            aria-labelledby="alert-dialog-title4"
